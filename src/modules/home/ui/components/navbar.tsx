      ...
      {session.data?.user ? (
        <div className="hidden lg:flex">
          <Button
            asChild
            variant="secondary"
            className="border-l bg-black border-r-0 px-12 h-full rounded-none text-white hover:bg-pink-400 transition-colors text-lg"
          >
        ...
        <div className="hidden lg:flex">
          <Button
            asChild
            variant="secondary"
            className="border-l  border-r-0 px-12 h-full rounded-none bg-white hover:bg-pink-400 transition-colors text-lg"
          >
